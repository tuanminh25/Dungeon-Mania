...
import dungeonmania.entities.playerManager.DefaultPickup;
import dungeonmania.entities.playerManager.PickupStrategy;
...
public class Player extends Entity implements Battleable {
    ...
    private PickupStrategy itemPickup;
    ...
    public Player(Position position, double health, double attack) {
        ...
        itemPickup = new DefaultPickup(this);
    }
    ...
    public boolean pickUp(Entity item) {
        return itemPickup.pickUp(inventory, item);
    }
    ...
    public <T extends InventoryItem> T getFirstInInventory(Class<T> itemType) {
