...
import dungeonmania.entities.logical.LogicalOperation;
...
public class GameMap {
    ...
    private void initRegisterSpawners() {
        ...
        game.register(() -> game.spawnSpider(game), Game.AI_MOVEMENT, "spawnSpiders");
    }
    ...
    public Conductor getConductor(Position p) {
        List<Entity> entities = getEntities(p);
        for (Entity entity : entities) {
            if (entity instanceof Conductor) {
                return (Conductor) entity;
            }
        }
        return null;
    }

    public LogicalOperation getLogical(Position p) {
        List<Entity> entities = getEntities(p);
        for (Entity entity : entities) {
            if (entity instanceof LogicalOperation) {
                return (LogicalOperation) entity;
            }
        }
        return null;
    }
